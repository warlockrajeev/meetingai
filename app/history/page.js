                  ...
                  <div className="flex items-center gap-4 min-w-0">
                    ...
                    <div className="text-left truncate flex-grow">
                      <div className="flex items-center gap-2 mb-0.5">
                        ...
                        {meeting.sentiment && (
                          <span className={`px-1.5 py-0.5 rounded-[4px] text-[8px] font-bold uppercase tracking-widest border ${
                            meeting.sentiment.overall === 'Positive' ? 'text-emerald-400 border-emerald-500/20 bg-emerald-500/5' :
                            meeting.sentiment.overall === 'Negative' ? 'text-red-400 border-red-500/20 bg-red-500/5' :
